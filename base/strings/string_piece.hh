...
// You can use StringPiece as a function or method parameter,
// A StringPiece parameter can receive a double-quoted string,
// a const char*, a string, or a StringPiece.
// Systematic use of StringPiece for arguments reduces data copies
// and strlen calls.
//
...
#ifndef BASE_STRINGS_STRING_PIECE_HH__
#define BASE_STRINGS_STRING_PIECE_HH__
...
typedef BaseStringPiece<std::string> StringPiece;

// Many of the StringPiece functions use different implementations for the
// 8-bit version, and we don't want lots of template expansions in
...
// StringPiece. Do not refer to this class directly, but
// rather to BasicStringPiece, StringPiece.
//
